...
print(nested_tuple)
print(nested_tuple[2]) # this will print (3, 4)
print(nested_tuple[2][0]) # this will print 3
...
print(my_tuple[::2]) # this will print every second element of the list b, starting from the first element, which is [1, 3, 5, 7, 9]
